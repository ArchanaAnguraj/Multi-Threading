...
//Program-->It is a collection of instruction which are prsent in hardDisk drive.
//Process-->It is a collection of instruction which are in prsent RAM.
...
//Where therad?--its prsent in process/task..
...
//Synchronization...-->its locking system ,at the any point of time only one thread is executed..
  //semphars,monitors->//set of instructions only one thread is executed at one point of time,..  
class BathRoom{
      //synchronized// void bathRoom()                            // sysnchronized method
      {
//		try
//		{
//			String t=Thread.currentThread().getName();
//			System.out.println(t+" "+"has entered into bathroom");  
//			Thread.sleep(3000);
//			System.out.println(t+" "+"has use bathroom");
//			Thread.sleep(3000);
//			System.out.println(t+" "+"has exit bathroom");
//		}
//		catch(Exception e)
//		{
//			e.printStackTrace();
//		}
		 ...
		 try
			{
				String t=Thread.currentThread().getName();
				System.out.println(t+" "+"is executed stm1");  
				Thread.sleep(3000);	
				System.out.println(t+" "+"is executed stm2");  
				Thread.sleep(3000);	
				System.out.println(t+" "+"is executed stm3");  
				Thread.sleep(3000);	
				System.out.println(t+" "+"is executed stm4");  
				Thread.sleep(3000);	
				System.out.println(t+" "+"is executed stm5");  
				Thread.sleep(3000);	
				synchronized(this)
				{
					System.out.println(t+" "+"is executed stm6");      // sysnchronized block
					Thread.sleep(3000);	
					System.out.println(t+" "+"is executed stm7");  
					Thread.sleep(3000);	
					System.out.println(t+" "+"is executed stm8");  
				}
			}
		 catch(Exception e)
			{
...
//public class MultiThreading {
//	public static void main(String[] args) {
//		BathRoom bw=new BathRoom();
//		Boy b=new Boy(bw);
//		Girl g=new Girl(bw);
//		Others o=new Others(bw);
//		
//		b.setName("Boy");
//		g.setName("Girl");
//		o.setName("Others");
